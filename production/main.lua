...
Security.authorizedDevices = {
    -- ダッシュボードのdevice_hashをそのまま追加
    -- 例: "FFMZ3GTSJC6J",  -- ダッシュボードで確認したdevice_hash
    -- 例: "ABC123DEF456",  -- 別のユーザーのdevice_hash

    -- テスト用デバイス（実際のダッシュボードのdevice_hashに置き換える）
    "FFMZ3GTSJC6J",  -- テストデバイス
}
...
Security.devicePlans = {
    ...
    -- テスト用デバイス（実際のダッシュボードのdevice_hashに置き換える）
    ["FFMZ3GTSJC6J"] = {
        plan = "starter",  -- trial, starter, pro, max
        expires_at = "2025-09-27 23:59:59",  -- 有効期限（YYYY-MM-DD HH:MM:SS）
        subscription_status = "active"  -- active, trial, expired
    },

    -- テスト用: 期限が近いケース（警告表示テスト）
    ["TEST_WARNING"] = {
        plan = "pro",
        expires_at = "2025-09-25 02:30:00",  -- 警告表示テスト用
        subscription_status = "active"
    }

    -- 新しいユーザー追加例:
    -- ["FFMZ3GTSJC6J"] = {  -- ダッシュボードで確認したdevice_hash
    --     plan = "starter",
