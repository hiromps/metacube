  ...
  return (
    <div className="min-h-screen" style={{background: '#1f2937'}}>
      ...
      <div className="container mx-auto px-4 max-w-6xl py-8">
        ...
        {userData.device && !userData.isSubscriptionActive && (
          <div className="mb-6 md:mb-8">
            {/* Show expired message if trial has ended */}
            {userData.device.trial_ends_at && new Date(userData.device.trial_ends_at) < new Date() && (
                ...
                <div className="space-y-4">
                  <div className="bg-black/20 border border-white/10 p-4 rounded-xl backdrop-blur-sm">
                    ...
                    <ul className="space-y-1 text-sm text-white/70 mb-4">
                      ...
                      <li className="flex items-center gap-2">
                        <span className="text-green-400">✅</span>
                        <span>現在のプラン: {userData.plan?.display_name || (userData.device?.status === 'trial' ? 'TRIAL (STARTER相当)' : 'STARTER')}</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-green-400">✅</span>
